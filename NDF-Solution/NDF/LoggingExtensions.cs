...
namespace NDF
{
    ...
    public static class LoggingExtensions
    {
        ...
        /// <summary>
        /// Logging a message noting the enter into a member..
        /// </summary>
        /// <param name="source">The logger to log the message to.</param>
        /// <param name="level">The logging level to log the message to.</param>
        /// <param name="memberName">Auto filled in by the system.</param>
        /// <param name="lineNumber">Auto filled in by the system.</param>
        public static void EnterLog(this ILogger source,LogLevel level, [CallerMemberName] string memberName = null, [CallerLineNumber] int lineNumber = 0)
        {
            if (source == null) return;

            if (!source.IsEnabled(level)) return;
            ...
            source.Log(level, DefaultEventId, logEvent, null, LogEventProperties.Formatter);
        ...
        /// <param name="memberName">Auto filled in by the system.</param>
        /// <param name="lineNumber">Auto filled in by the system.</param>
        public static void EnterLog(this ILogger source,LogLevel level, EventId eventId, [CallerMemberName] string memberName = null, [CallerLineNumber] int lineNumber = 0)
        {
            if (source == null) return;
            ...
            logEvent.AddProp(PropertyMemberName, memberName);
            logEvent.AddProp(PropertyLineNumber, lineNumber);
            source.Log(level, eventId, logEvent, null, LogEventProperties.Formatter);

        }

        /// <summary>
        /// Logging a message noting the exiting a member.
        /// </summary>
        /// <param name="source">The logger to log the message to.</param>
        /// <param name="level">The logging level to log the message to.</param>
        /// <param name="memberName">Auto filled in by the system.</param>
        /// <param name="lineNumber">Auto filled in by the system.</param>
        public static void ExitLog(this ILogger source, LogLevel level, [CallerMemberName] string memberName = null, [CallerLineNumber] int lineNumber = 0)
        {
            if (source == null) return;
        ...
        /// <param name="memberName">Auto filled in by the system.</param>
        /// <param name="lineNumber">Auto filled in by the system.</param>
        public static void ExitLog(this ILogger source,LogLevel level, EventId eventId, [CallerMemberName] string memberName = null, [CallerLineNumber] int lineNumber = 0)
        {
            if (source == null) return;
        ...
        /// <summary>
        /// Logging a message to the logger.
        /// </summary>
        /// <param name="source">The logger to log the message to.</param>
        /// <param name="level">The logging level to log the message to.</param>
        ...
        /// <param name="memberName">Auto filled in by the system.</param>
        /// <param name="lineNumber">Auto filled in by the system.</param>
        public static void LogMessage(this ILogger source,LogLevel level, string message, [CallerMemberName] string memberName = null, [CallerLineNumber] int lineNumber = 0)
        {
            if (source == null) return;
        ...
        /// <param name="memberName">Auto filled in by the system.</param>
        /// <param name="lineNumber">Auto filled in by the system.</param>
        public static void LogMessage(this ILogger source,LogLevel level, string message, EventId eventId, [CallerMemberName] string memberName = null, [CallerLineNumber] int lineNumber = 0)
        {
            if (source == null) return;
        ...
        /// <param name="memberName">Auto filled in by the system.</param>
        /// <param name="lineNumber">Auto filled in by the system.</param>
        public static void LogMessage(this ILogger source,LogLevel level, string message, Exception exception, [CallerMemberName] string memberName = null, [CallerLineNumber] int lineNumber = 0)
        {
            if (source == null) return;
            ...
            logEvent.AddProp(PropertyMemberName, memberName);
            logEvent.AddProp(PropertyLineNumber, lineNumber);
            source.Log(level, DefaultEventId, logEvent, exception, LogEventProperties.Formatter);
        }
        ...
        /// <param name="memberName">Auto filled in by the system.</param>
        /// <param name="lineNumber">Auto filled in by the system.</param>
        public static void LogMessage(this ILogger source,LogLevel level, string message, Exception exception, EventId eventId, [CallerMemberName] string memberName = null, [CallerLineNumber] int lineNumber = 0)
        {
            if (source == null) return;
            ...
            logEvent.AddProp(PropertyMemberName, memberName);
            logEvent.AddProp(PropertyLineNumber, lineNumber);
            source.Log(level, eventId, logEvent, exception, LogEventProperties.Formatter);
